...
plot_conservation(
  ...
  plot_type = "scatter",
  highlight_n = 10,
  file_path = file.path(output_dir, "conservation_scatter.pdf")
)
...
plot_conservation(
  conservation_results,
  plot_type = "histogram",
  file_path = file.path(output_dir, "conservation_histogram.pdf")
)
...
- [Customizing trajectory models](trajectory_modeling.html)
- [Working with HDF5 files](hdf5_guide.html)
