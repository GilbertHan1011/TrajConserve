...
TrajConserve relies on Stan for Bayesian modeling. To avoid compilation issues, you need to set up your environment correctly:
...
These settings ensure that Stan can properly compile with your C++ toolchain. Without these configurations, you might encounter errors like:
...
Exit status: 2
Stderr:
stan/lib/stan_math/make/compiler_flags:145: "Stan cannot detect if your compiler has the C++17 standard."
stan/lib/stan_math/make/libraries:114: *** "Need to set TBB_CXX_TYPE for non-standard compiler."
```
